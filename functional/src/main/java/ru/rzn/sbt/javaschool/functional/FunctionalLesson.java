...
public class FunctionalLesson {
    ...
    public String ustas2alex_f(List<String> words) {
        StringBuilder sb = new StringBuilder(words.size());
//        words.forEach(e -> sb.append(e.charAt(e.length() / 2)));
        words.parallelStream().forEachOrdered(e -> sb.append(e.charAt(e.length()/2)));
        return sb.toString();
    }
    ...
    public String properties_f(Map<String, Object> map) {
        StringBuilder sb = new StringBuilder();
//        map.entrySet().forEach((Map.Entry o) -> sb.append(String.format("%s=%s\n", o.getKey(), o.getValue())));

        map.entrySet().parallelStream().forEachOrdered(o -> sb.append(String.format("%s=%s\n", o.getKey(), o.getValue())));
        return sb.toString();
    }
